...
export default function MultiLinkCell({ value, onSave, styles, placeholder }) {
  ...
  if (!editing && hasContent) {
    return (
      ...
      // grow to fit the text anyway unless this is set. Round 81 item 3 —
      // tightened from 320 to ~"https://abc" width per the user's literal
      // ask.
      <div style={{ display: "flex", alignItems: "flex-start", gap: 4, maxWidth: 110 }}>
