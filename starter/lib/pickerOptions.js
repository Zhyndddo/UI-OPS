...
//
// Round 21 follow-up: replaced the old LYRIC/Đã có/Chưa có/Không có list
// with this new set, per explicit request. Every reader of this list uses
// PickSelect (not a plain <select>), so any release still holding an old
// value shows up flagged as "(unrecognized — pick to fix)" instead of
// silently going blank.
export const MV_TYPE_OPTIONS = ["", "Full", "Lyric", "Visualization"];
