...
//  - PLAYLIST YOUTUBE MUSIC | The Hit List / RELEASED — still no
//    confirmed URL for either of these 2.
...
export const MILESTONE_CHART_LINKS = {
  ...
  // Round 293 — YouTube's official YOUTUBE CHARTS entries, direct request
  // with a confirmed URL per chart (the gap this file's header used to
  // flag — the sheet's 5 YouTube hyperlinks didn't line up label-for-label
  // with PLATFORM_CHARTS' 5 entries, so they were left out until now
  // rather than guessed). PLAYLIST YOUTUBE MUSIC's 2 entries still have no
  // confirmed URL — unchanged, see the "still needs" note above.
  "YOUTUBE CHARTS | Trending Music": "https://charts.youtube.com/charts/TrendingVideos/vn",
  "YOUTUBE CHARTS | Daily Top Music Videos": "https://charts.youtube.com/charts/TopVideos/vn/daily",
  "YOUTUBE CHARTS | Weekly Top Music Videos": "https://charts.youtube.com/charts/TopSongs/vn/weekly",
  "YOUTUBE CHARTS | Weekly Top Artists": "https://charts.youtube.com/charts/TopArtists/vn/weekly",
  "YOUTUBE CHARTS | Daily Top Songs on Shorts": "https://charts.youtube.com/charts/TopShortsSongs/vn/daily",
};
