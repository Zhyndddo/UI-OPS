...
const NAV = [
  ...
  // Round 56 — distinct from Summary: Summary is a live operational
  // worklist (per-team not-done counts); Report is a coherent read across
  // releases/booking/package data — tables + charts, for "how's the
  // pipeline/booking/revenue actually doing" rather than "what's not done".
