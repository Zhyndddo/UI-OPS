...
const NAV = [
  ...
  { num: "04", label: "Artists", href: "/artists" },
  { num: "05", label: "Labels", href: "/labels" },
  { num: "06", label: "Summary", href: "/summary" },
];
// New Release (creation happens via the "+ New Release" button on the
// Dashboard instead) and Tools (the pipeline-check diagnostic) are
// deliberately not in the nav anymore — both pages still exist, just not
// linked from here.
