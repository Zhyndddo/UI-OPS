...
import { loadMyActiveSecretMessages } from "./secretMessages";
...
const NAV = [
  ...
  { label: "Report", href: "/report", devOnly: true },
...
export default function Sidebar({ open = true, onClose, mobile = false }) {
  ...
  // for a specific audience, above Khác" pattern. devOnly items (just
  // Report, Round 255) are dropped for anyone else before numbering, so
  // numbers stay contiguous instead of skipping.
