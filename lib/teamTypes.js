...
export const TEAM_TICKET_TYPES = {
  OPS: ["phai_sinh", "manual_claim", "report_conflict"],
...
export const TEAM_WORKSTATION_TYPES = {
  Marketing: ["booking", "package_price", "media_package"],
...
export const WORKSTATION_TYPE_LABELS = {
  ...
  media_package: "New Media Package",
};
...
export const WORKSTATION_ROUTES = {
  ...
  media_package: "/workstation/media-package",
};
