...
export const TEAM_TICKET_TYPES = {
  OPS: [
    "phai_sinh", "batch_phai_sinh", "manual_claim", "report_conflict", "pitching_info", "pitching",
  ...
  AR: [
    "phai_sinh", "batch_phai_sinh", "manual_claim", "report_conflict", "artist_profile", "phu_luc", "pitching_info", "pitching",
