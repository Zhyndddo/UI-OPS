...
// Round 186 — "Zhyn's Special" is now a real third theme value, not a
// dark-theme override. Three valid values: "dark" (orange, default),
// "light", "zhyn" (purple). Which ones an account is ALLOWED to pick is
