...
function CoTrongNetYoutubePanel({ styles, draft, onChange, onSend, sent, youtubeAdsUrl, youtubeBookingNote, onChangeYoutubeAdsUrl, onChangeYoutubeBookingNote }) {
  ...
  return (
    <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 8, padding: 12, marginBottom: 12 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: "#ff6b1a", textTransform: "uppercase" }}>
...
// panel in this file.
function ArtistProfileVerifyPanel({ styles, artistTags, selected, onToggleArtist, platformTypes, onPlatformToggle, existingByArtist }) {
            ...
            {textField && form[key] === "true" && (
              <div style={{ marginTop: 6 }}>
                <input
                  ...
                  value={form[textField.field] || ""}
                  onChange={(e) => update(textField.field, e.target.value)}
