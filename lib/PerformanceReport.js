...
// link_share added round 230 — the public Performance share page uses it
// (song mode only) to crawl a cover image via /api/crawl-og-image. Not
// used anywhere else in this file.
const RELEASE_FIELDS = "id, did, title, main_artist, main_artist_tags, package_total_value, release_date, project_type, status, link_share";
