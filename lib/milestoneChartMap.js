...
//
// Round 207 — 5 YouTube target names updated to match PLATFORM_CHARTS.
// YouTube's corrected tab labels (VIETNAM TRENDING MUSIC -> Trending
// Music, Top Videos Daily -> Daily Top Music Videos, TOP ARTISTS WEEKLY
// -> Weekly Top Artists, PLAYLIST YOUTUBE -> PLAYLIST YOUTUBE MUSIC for
// both playlists), so any future re-run of the import scripts below
// lands on the currently-correct name. The raw (left-hand) keys are
// untouched — those are exactly what the team's sheets happened to say
// and aren't part of this rename. "TOP SONGS WEEKLY"/"TOP SONGS DAILY"
// targets are also untouched — those 2 tabs were dropped, not renamed
// (see add-round207-youtube-chart-renames.sql).
const CHART_MAP = {
  ...
  // Round 190 — real recurring chart, not a typo (2 rows in "total
  // today", 2 more in TOTAL_STREAK) — added to PLATFORM_CHARTS too, see
  // app/workstation/milestone/page.js.
  "New Release on Apple␟Apple": { chart: "New Release on Apple", platform: "Apple" },
  ...
  "PLAYLIST YOUTUBE CHARTS | RELEASED␟Youtube": { chart: "PLAYLIST YOUTUBE MUSIC | RELEASED", platform: "YouTube" },
  "PLAYLIST YOUTUBE CHARTS | The Hit List␟Youtube": { chart: "PLAYLIST YOUTUBE MUSIC | The Hit List", platform: "YouTube" },
  "PLAYLIST YOUTUBE | RELEASED␟Youtube": { chart: "PLAYLIST YOUTUBE MUSIC | RELEASED", platform: "YouTube" },
  "PLAYLIST YOUTUBE | The Hit List␟Youtube": { chart: "PLAYLIST YOUTUBE MUSIC | The Hit List", platform: "YouTube" },
  ...
  "YOUTUBE CHART | TOP VIDEO␟YOUTUBE": { chart: "YOUTUBE CHARTS | Daily Top Music Videos", platform: "YouTube" },
  "YOUTUBE CHARTS | Daily Top Music Videos␟Youtube": { chart: "YOUTUBE CHARTS | Daily Top Music Videos", platform: "YouTube" },
  "YOUTUBE CHARTS | Daily Top Songs on Shorts␟Youtube": { chart: "YOUTUBE CHARTS | Daily Top Songs on Shorts", platform: "YouTube" },
  "YOUTUBE CHARTS | Nhạc thịnh hành␟Youtube": { chart: "YOUTUBE CHARTS | Trending Music", platform: "YouTube" },
  "YOUTUBE CHARTS | TOP SONGS DAILY␟Youtube": { chart: "YOUTUBE CHARTS | TOP SONGS DAILY", platform: "YouTube" },
  "YOUTUBE CHARTS | TopArtists weekly␟Youtube": { chart: "YOUTUBE CHARTS | Weekly Top Artists", platform: "YouTube" },
  ...
  "YOUTUBE CHARTS | TopVideos daily␟Youtube": { chart: "YOUTUBE CHARTS | Daily Top Music Videos", platform: "YouTube" },
  "YOUTUBE CHARTS | Vietnam Trending Music␟Youtube": { chart: "YOUTUBE CHARTS | Trending Music", platform: "YouTube" },
  "YOUTUBE CHARTS | Vietnam Trending Overall␟Youtube": { chart: "YOUTUBE CHARTS | Trending Music", platform: "YouTube" },
  "YOUTUBE CHARTS | Weekly Top Artists␟Youtube": { chart: "YOUTUBE CHARTS | Weekly Top Artists", platform: "YouTube" },
  "YOUTUBE CHARTS | Weekly Top Music Videos␟Youtube": { chart: "YOUTUBE CHARTS | Weekly Top Music Videos", platform: "YouTube" },
  "YOUTUBE MUSIC CHART | TOP ARTIST WEEKLY␟Youtube": { chart: "YOUTUBE CHARTS | Weekly Top Artists", platform: "YouTube" },
  "YOUTUBE MUSIC CHART | TOP SONGS WEEKLY␟YOUTUBE": { chart: "YOUTUBE CHARTS | TOP SONGS WEEKLY", platform: "YouTube" },
  "YOUTUBE MUSIC CHART | TOP SONGS WEEKLY␟Youtube": { chart: "YOUTUBE CHARTS | TOP SONGS WEEKLY", platform: "YouTube" },
  "YOUTUBE MUSIC | DAILY TOP VIDEO␟Youtube": { chart: "YOUTUBE CHARTS | Daily Top Music Videos", platform: "YouTube" },
  "YOUTUBE MUSIC | WEEKLY TOP ARTIST␟Youtube": { chart: "YOUTUBE CHARTS | Weekly Top Artists", platform: "YouTube" },
  ...
  "youworldtop | Trending On YouTube Vietnam Today␟Youtube": { chart: "YOUTUBE CHARTS | Trending Music", platform: "YouTube" },

  // Round 239 — the CSV export the team sent for the pre-app-adoption
  // Milestone log (scripts/import-milestone-round239-csv.js) has ~73 rows
  // across 6 chart names with the DSP column simply left blank (a
  // spreadsheet fill-down gap, not a different chart) — each one already
  // has an unambiguous mapping above under its normal DSP value, so these
  // are pass-through aliases to those same targets rather than new
  // charts. Safe because each chart name is unique enough on its own to
  // not collide with anything on a different platform.
  "APPLE MUSIC CHART - Top POP Album␟": { chart: "APPLE MUSIC - Top POP Albums", platform: "Apple" },
  "APPLE MUSIC CHART - Top ALBUMs Vietnam␟": { chart: "APPLE MUSIC - Top ALBUMs Vietnam", platform: "Apple" },
  "APPLE CHARTS - Top ALBUMs Vietnam␟": { chart: "APPLE MUSIC - Top ALBUMs Vietnam", platform: "Apple" },
  "Apple Playlist | Vietnam Ơi␟": { chart: "Playlist Vietnam Ơi!", platform: "Apple" },
  "Apple Playlist | New Music Daily␟": { chart: "Playlist New Music Daily", platform: "Apple" },
  "ZingCharts␟": { chart: "ZMP3|ZING CHART", platform: "Zing" },
};
