...
// Round 289 — shared legend entries for rowHighlightColor's two colors,
// for the pages that use it (Pitching, New Release Setup, Re-Check,
// Pre-release — see ColorLegend.js) — one source so the wording/order
// can't drift between them the way three separate copies could.
export const DATE_HIGHLIGHT_LEGEND = [
  { color: "#FBEC5D", label: "Releasing today" },
  { color: "#B3EBF2", label: "Releasing this week (last Sunday–next Sunday)" },
];
