...
// always both shown. "Zhyn's Special" (purple, a real third value on
// ThemeContext — see that file) only shows as a third option for the one
// account AuthContext.js's `canUseZhynTheme` allows; everyone else's
// panel looks exactly like the original 2-option toggle.
const THEME_OPTIONS = [
  { value: "dark", label: "☾ Dark" },
  { value: "light", label: "☀ Light" },
];
const ZHYN_THEME_OPTION = { value: "zhyn", label: "✦ Zhyn's Special" };
