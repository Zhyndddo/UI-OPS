...
export const TASK_PHASE = {
  ...
  // Round 325 — Marketing's "Dự Án" subteam project count (see
  // app/task-table/page.js's loadSubteamProjectCounts) isn't tied to one
  // release-lifecycle phase either — a release stays tagged to a subteam
  // across its whole lifetime, not just one phase of it.
  "subteam:project": "Not phase-bound",
};
